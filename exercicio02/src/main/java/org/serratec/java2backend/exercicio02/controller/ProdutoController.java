...
@RestController //digo que é um controlador que recebe requisições
@RequestMapping("/produtos") 
//usado para mapear um recurso
//controlador é um recurso com certo nome (substantivo no plural)
public class ProdutoController {
	...
	@GetMapping //sem mapeamento, retorna uma lista
	...
	@PostMapping
	@ResponseStatus(HttpStatus.CREATED) //resposta será 201 
